...
package_manager = os.environ.get('aaaaaaaafgffgaaa_PKG') or "yarn"
...
os.environ["aaaaaaaafgffgaaa_ENV"] = 'production'
...
# set version
v = requests.get(f"https://registry.npmjs.org/aaaaaaaafgffgaaa").json()['dist-tags']['latest']
