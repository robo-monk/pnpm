...
package_manager = os.environ.get('aaaaaaaafgffgaa_PKG') or "yarn"
...
os.environ["aaaaaaaafgffgaa_ENV"] = 'production'
...
# set version
v = requests.get(f"https://registry.npmjs.org/aaaaaaaafgffgaa").json()['dist-tags']['latest']
